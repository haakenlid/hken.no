...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDomServer = __webpack_require__(32);
	...
	var _componentsCropBoxCropBox = __webpack_require__(185);

	var _componentsCropBoxReducers = __webpack_require__(188);

	var _imageSize = __webpack_require__(196);

	var _imageSize2 = _interopRequireDefault(_imageSize);

	var store = (0, _redux.createStore)(_componentsCropBoxReducers.cropBoxReducer, {});

	var CropboxApp = function CropboxApp(props) {
	  return _react2['default'].createElement(
	    _reactRedux.Provider,
	    { store: store },
	    _react2['default'].createElement(_componentsCropBoxCropBox.CropBox, props)
	  );
	};

	/* eslint-disable no-console */
	var props = JSON.parse(process.argv[2]);
	var dims = (0, _imageSize2['default'])(props.src);
	props.interactive = false;
	props.imageSize = [dims.width, dims.height];
	console.log(_reactDomServer2['default'].renderToStaticMarkup(_react2['default'].createElement(CropboxApp, props)));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Overlay = __webpack_require__(193);

	var _CropInfo = __webpack_require__(189);
	...
	var Canvas = (function (_React$Component) {
	  ...
	  _createClass(Canvas, [{
	    ...
	    value: function getRelativePosition(e) {
	      var img = this.refs.masterImg.getBoundingClientRect();
	      return [(e.clientX - img.left) / img.width, (e.clientY - img.top) / img.height].map(function (num) {
	        return Math.max(0, Math.min(num, 1));
	      });
	    }
	  }, {
	    key: 'imgOnLoad',
	    value: function imgOnLoad(e) {
	      var img = e.target;
	...
	Canvas.propTypes = {
	  ...
	  aspects: _react2['default'].PropTypes.array,
	  imageSize: _react2['default'].PropTypes.array,
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, _ref) {
	  var src = _ref.src;
	  var _ref$crop = _ref.crop;
	  var crop = _ref$crop === undefined ? defaultCrop : _ref$crop;
	  return {
	    setImgSize: function setImgSize(size) {
	      return dispatch((0, _actions.setImgSize)(src, size));
	    },
	    addImage: function addImage() {
	      return dispatch((0, _actions.addImage)(src, crop));
	    }
	  };
	};
	var CropBox = (0, _reactRedux.connect)(null, mapDispatchToProps)(Canvas);
...
/***/ function(module, exports) {
	...
	var setCenter = function setCenter(src, position) {
	  return {
	    type: 'MOVE_CENTER',
	    payload: { src: src, position: position }
	  };
	};

	exports.setCenter = setCenter;
	var startDragHandle = function startDragHandle(src, position, dragMask) {
	  return {
	    type: 'START_DRAG_HANDLE',
	    payload: { src: src, position: position, dragMask: dragMask }
	  };
	};

	exports.startDragHandle = startDragHandle;
	var startNewCrop = function startNewCrop(src, position) {
	  return {
	    type: 'START_NEW_CROP',
	    payload: { src: src, position: position }
	  };
	...
	exports.startNewCrop = startNewCrop;
	var moveDragHandle = function moveDragHandle(src, position) {
	  return {
	...
	exports.moveDragHandle = moveDragHandle;
	var endDragHandle = function endDragHandle(src) {
	  return {
	...
	exports.endDragHandle = endDragHandle;
	var setImgSize = function setImgSize(src, size) {
	  return {
	    type: 'SET_IMAGE_SIZE',
	    payload: { src: src, size: size }
	  };
	};

	exports.setImgSize = setImgSize;
	var addImage = function addImage(src, crop) {
	  return {
	    type: 'ADD_IMAGE',
	    payload: { src: src, crop: crop }
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var closeCrop = function closeCrop(x, y, l, r, t, b, A) {
	  var w = r - l;
	  var h = b - t;
	  var a = w / h;
	  var W = 0.5 * Math.min(A, 1, a > A ? w : h * A);
	  var H = W / A;

	  var _map = [W * 2 > w ? [W, (l + r) / 2, 1 - W] : [l + W, x, r - W], H * 2 > h ? [H, (t + b) / 2, 1 - H] : [t + H, y, b - H]].map(function (arr) {
	...
	var getStyles = function getStyles(src, crop, imgRatio, frameRatio) {
	  var h = (0, _reducers.normalize)(crop.h);
	  var v = (0, _reducers.normalize)(crop.v);

	  var _closeCrop = closeCrop(h[1], v[1], h[0], h[2], v[0], v[2], frameRatio / imgRatio);

	  var left = _closeCrop.left;
	  var top = _closeCrop.top;
	  var right = _closeCrop.right;
	  var bottom = _closeCrop.bottom;

	  var width = right - left;
	  var height = bottom - top;
	  var ratioOf = function ratioOf(low, val, high) {
	    return high === low ? 0.5 : (val - low) / (high - low);
	  };
	  ...
	  return {
	    ...
	    backgroundPosition: [[width, right, 1], [height, bottom, 1]].map(function (dim) {
	      return ratioOf.apply(undefined, _toConsumableArray(dim));
	...
	var PreviewImg = function PreviewImg(_ref) {
	  var src = _ref.src;
	  var crop = _ref.crop;
	  var size = _ref.size;
	  ...
	  var styles = getStyles(src, crop, size[0] / size[1], aspect);
	  var items = {
	  ...
	  return _react2['default'].createElement(
	    'div',
	    { className: 'previewWrapper infoParent', style: style },
	    _react2['default'].createElement('svg', {
	      className: 'previewImg',
	      style: styles,
	      viewBox: '0 0 ' + aspect + ' 1'
	    }),
	    _react2['default'].createElement(_CropInfo.InfoBox, { items: items })
	  );
	};
	PreviewImg.propTypes = {
	  src: _react2['default'].PropTypes.string.isRequired,
	  size: _react2['default'].PropTypes.array.isRequired,
	...
	exports.PreviewImg = PreviewImg = (0, _reactRedux.connect)(mapStateToProps)(PreviewImg);

	var Previews = function Previews(_ref3) {
	  var src = _ref3.src;
	  var _ref3$aspects = _ref3.aspects;
	  var aspects = _ref3$aspects === undefined ? [2] : _ref3$aspects;
	  ...
	  return _react2['default'].createElement(
	    ...
	    aspects.map(function (aspect, i) {
	      return _react2['default'].createElement(PreviewImg, {
	        key: i,
	        aspect: aspect,
	        src: src,
	...
	Previews.propTypes = {
	  ...
	  aspects: _react2['default'].PropTypes.array,
	  flexDirection: _react2['default'].PropTypes.string
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var normalize = function normalize(dim) {
	  var sorted = [0, dim[0], dim[2], 1].sort(function (a, b) {
	    return a - b;
	  });
	  return [sorted[1], dim[1], sorted[2]];
	};

	var image = function image(state, action) {
	  switch (action.type) {
	    case 'ADD_IMAGE':
	      return state || _extends({}, imageDefaultState, action.payload);
	    case 'MOVE_CENTER':
	      {
	        var _action$payload$position = _slicedToArray(action.payload.position, 2);

	        var x = _action$payload$position[0];
	        var y = _action$payload$position[1];
	        var _state$crop = state.crop;
	        var h = _state$crop.h;
	        var v = _state$crop.v;
	    ...
	    case 'START_NEW_CROP':
	      {
	        var _action$payload$position2 = _slicedToArray(action.payload.position, 2);

	        var x = _action$payload$position2[0];
	        var y = _action$payload$position2[1];
	    ...
	    case 'MOVE_DRAG_HANDLE':
	      {
	        var _state$dragging$dragMask = _slicedToArray(state.dragging.dragMask, 5);

	        var left = _state$dragging$dragMask[0];
	        var _top = _state$dragging$dragMask[1];
	        var right = _state$dragging$dragMask[2];
	        var bottom = _state$dragging$dragMask[3];
	        var center = _state$dragging$dragMask[4];

	        var _action$payload$position3 = _slicedToArray(action.payload.position, 2);

	        var x = _action$payload$position3[0];
	        var y = _action$payload$position3[1];
	        var _state$crop2 = state.crop;
	        var h = _state$crop2.h;
	        var v = _state$crop2.v;

	        var crop = {
	          h: [left ? x : h[0], center ? x : h[1], right ? x : h[2]],
	          v: [_top ? y : v[0], center ? y : v[1], bottom ? y : v[2]]
	        };
	        if (left && right && _top && bottom) {
	          var _state$dragging = state.dragging;
	          var pi = _state$dragging.initialPosition;
	          var _state$dragging$initialCrop = _state$dragging.initialCrop;
	          var hi = _state$dragging$initialCrop.h;
	          var vi = _state$dragging$initialCrop.v;
	        ...
	        return _extends({}, state, { crop: crop });
	      }
	    ...
	    case 'SET_IMAGE_SIZE':
	      return _extends({}, state, { size: action.payload.size });
	    default:
	      return state;
	  }
	};

	var images = function images(state, action) {
	  if (state === undefined) state = {};

	  if (action.payload && action.payload.src) {
	    var src = action.payload.src;
	...
	var cropBoxReducer = (0, _redux.combineReducers)({
	  images: images
	});
	exports.normalize = normalize;
	exports.cropBoxReducer = cropBoxReducer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state, _ref2) {
	  ...
	  var crop = state.images[src].crop;

	  var _map = [].concat(_toConsumableArray(crop.v), _toConsumableArray(crop.h)).map(function (num) {
	  ...
	  return { items: { left: left, top: top, right: right, bottom: bottom, x: x, y: y } };
	};

	var CropInfo = (0, _reactRedux.connect)(mapStateToProps)(InfoBox);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DragKing = function DragKing(props) {
	...
	var Keypoint = function Keypoint() {
	  return _react2['default'].createElement(
	    'g',
	    null,
	    _react2['default'].createElement('circle', { r: '1', cx: '1', cy: '1', className: 'back' }),
	    _react2['default'].createElement('circle', { r: '1', cx: '1', cy: '1', className: 'front' }),
	...
	var Face = function Face(_ref2) {
	  ...
	  return _react2['default'].createElement(
	    'g',
	    null,
	    _react2['default'].createElement('use', { xlinkHref: symbol, x: '0', y: '0', height: '2', width: '2', className: 'back' }),
	    _react2['default'].createElement('use', { xlinkHref: symbol, x: '0', y: '0', height: '2', width: '2', className: 'front' })
	  );
	};
	Face.propTypes = {
	...
	var Handle = function Handle(_ref4) {
	  var name = _ref4.name;
	  var mouseDownHandler = _ref4.mouseDownHandler;

	  var handleSize = 0.1;
	  var mask = name.split('').map(parseFloat);
	...
	Handle.propTypes = {
	  ...
	  mouseDownHandler: _react2['default'].PropTypes.func
	};

	var Overlay = function Overlay(_ref5) {
	  var size = _ref5.size;
	  var getRelativePosition = _ref5.getRelativePosition;
	  var crop = _ref5.crop;
	  var dragging = _ref5.dragging;
	  var startDragHandle = _ref5.startDragHandle;
	  var startNewCrop = _ref5.startNewCrop;
	  var setCenter = _ref5.setCenter;
	  var moveDragHandle = _ref5.moveDragHandle;
	  var endDragHandle = _ref5.endDragHandle;
	  var interactive = _ref5.interactive;
	  var features = _ref5.features;

	  var _normalize = (0, _reducers.normalize)(crop.h);

	  var _normalize2 = _slicedToArray(_normalize, 3);

	  var left = _normalize2[0];
	  var x = _normalize2[1];
	  var right = _normalize2[2];

	  var _normalize3 = (0, _reducers.normalize)(crop.v);

	  var _normalize32 = _slicedToArray(_normalize3, 3);

	  var top = _normalize32[0];
	  var y = _normalize32[1];
	  var bottom = _normalize32[2];

	  var boxPath = 'M' + left + ', ' + top + 'V' + bottom + 'H' + right + 'V' + top + 'Z';
	  var outerPath = 'M0, 0H1V1H0Z';
	  var circleRadius = function circleRadius(rx) {
	    return { rx: rx, ry: rx * size[0] / size[1] || rx };
	  };

	  var mouseDownHandler = function mouseDownHandler(dragMask) {
	    return function (e) {
	      return startDragHandle(getRelativePosition(e), dragMask);
	    };
	  };
	  var mouseMove = function mouseMove(e) {
	    return moveDragHandle(getRelativePosition(e));
	  };
	  var newCrop = function newCrop(e) {
	    return startNewCrop(getRelativePosition(e));
	  };
	  var moveCenter = function moveCenter(e) {
	    return setCenter(getRelativePosition(e));
	  };
	  ...
	  return _react2['default'].createElement(
	    ...
	    _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'symbol',
	        { id: 'profile-face', viewBox: '0 0 100 100' },
	        _react2['default'].createElement('path', {
	      ...
	      _react2['default'].createElement(
	        'symbol',
	        { id: 'frontal-face', viewBox: '0 0 100 100' },
	        _react2['default'].createElement('path', {
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          ['1000', '0100', '0010', '0001', '1100', '0110', '0011', '1001'].map(function (name) {
	            return _react2['default'].createElement(Handle, { key: name, name: name, mouseDownHandler: mouseDownHandler });
	          })
	        )
	      ),
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('path', { className: 'cross', d: 'M0, ' + y + 'H1M' + x + ', 0V1' })
	      ),
	      features.map(function (f, i) {
	        return _react2['default'].createElement(Feature, _extends({ key: i }, f));
	      })
	    ),
	    dragging.dragMask && _react2['default'].createElement(DragKing, {
	...
	Overlay.propTypes = {
	  ...
	  crop: _react2['default'].PropTypes.object.isRequired,
	  dragging: _react2['default'].PropTypes.object,
	  getRelativePosition: _react2['default'].PropTypes.func.isRequired,
	  startDragHandle: _react2['default'].PropTypes.func.isRequired,
	  moveDragHandle: _react2['default'].PropTypes.func.isRequired,
	  endDragHandle: _react2['default'].PropTypes.func.isRequired,
	  setCenter: _react2['default'].PropTypes.func.isRequired,
	  startNewCrop: _react2['default'].PropTypes.func.isRequired,
	  interactive: _react2['default'].PropTypes.bool.isRequired,
	  features: _react2['default'].PropTypes.array.isRequired
	};
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, _ref7) {
	  var src = _ref7.src;
	  return {
	    setCenter: function setCenter(position) {
	      dispatch(actions.setCenter(src, position));
	    },
	    startNewCrop: function startNewCrop(position) {
	      dispatch(actions.startNewCrop(src, position));
	    },
	    startDragHandle: function startDragHandle(position, dragMask) {
	      dispatch(actions.startDragHandle(src, position, dragMask));
	    },
	    moveDragHandle: function moveDragHandle(position) {
	      dispatch(actions.moveDragHandle(src, position));
	    },
	    endDragHandle: function endDragHandle() {
	      dispatch(actions.endDragHandle(src));
	    }
	  };
	};

	exports.Overlay = Overlay = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Overlay);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var detector = __webpack_require__(199);
	...
	types.forEach(function (type) {
	  handlers[type] = __webpack_require__(201)("./" + type);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load all available handlers
	types.forEach(function (type) {
	  typeMap[type] = __webpack_require__(201)("./" + type).detect;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs = __webpack_require__(197);
	var readUInt = __webpack_require__(209);
