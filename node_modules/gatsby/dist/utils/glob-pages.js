...
module.exports = function (directory, callback) {
  ...
  var fileTypesToGlob = ['ipynb', 'coffee', 'cjsx', 'jsx', 'js', 'md', 'html', 'json', 'yaml', 'toml'];
  ...
  (0, _glob2['default'])(globQuery, null, function (err, pages) {
    ...
    pages.forEach(function (page) {
      ...
      pageData.file = parsed = (0, _parseFilepath2['default'])(_path2['default'].relative(directory + '/pages', page));
